...
description: Style guide for the OT-OCN developer portal.
...
This page will help you learn about the Markdown used in the OT-OCN Developer Portal, but the list is not intended to be exhaustive. Read the [docusaurus markdown features](https://docusaurus.io/docs/next/markdown-features) for more examples.
...
You can even [link to the Forum!](https://forum.otocn.org)
```
...
```text
[I'm an inline-style link](https://forum.otocn.org)

[I'm an inline-style link with title](https://forum.otocn.org "OT-OCN Forum")
...
URLs and URLs in angle brackets will automatically get turned into links. http://www.otocn.org or <http://www.otocn.org>.

Some text to show that the reference links can follow later.

[arbitrary case-insensitive reference text]: https://www.otocn.org
[1]: https://forum.otocn.org
[link text itself]: https://www.otocn.org
```
