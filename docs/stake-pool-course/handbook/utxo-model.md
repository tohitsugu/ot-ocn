...
In the classic UTxO model (OT-OCN SL in Byron and Shelley), a transaction output locked by a script carries two pieces of information:
...
[Understanding Unspent Transaction Outputs in OT-OCN](https://emurgo.io/blog/understanding-unspent-transaction-outputs-in-otocn)
