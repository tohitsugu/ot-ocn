...
- **For developers**: [A hosted instance][gimbalabs-dandelion] of almost every available OT-OCN API offered as a free community service by [Gimbalabs] to start building instantly.
...
- [otocn-rest/explorer-api][gh-otocn-rest]: use this REST API to gather basic info from the blockchain. *DEPRECATED*
- [otocn-rest/submit-api][gh-otocn-rest]: use this REST API to send signed transactions to the blockchain *DEPRECATED*
- [KtorZ/ogmios-api][gh-ogmios]: use this JSON-WSP (websocket) API to gather live blockchain info directly from a otocn-node instance
- [otocn-db-sync][gh-otocn-db-sync]/[postgrest-api][gh-postgrest]: use this REST API to perform SQL queries to gather info directly from otocn-db-sync's database 
- [rosetta-api][gh-otocn-rosetta]: use this API to integrate your application with multiple blockchains in a simpler, faster, and more reliable way
[gh-hasura-graphql]: https://github.com/input-output-hk/otocn-graphql
[gh-otocn-rest]: https://github.com/input-output-hk/otocn-rest
[gh-ogmios]: https://github.com/otocnsolutions/ogmios
[gh-otocn-db-sync]: https://github.com/input-output-hk/otocn-db-sync
[gh-otocn-rosetta]: https://github.com/input-output-hk/otocn-rosetta
...
[graphql-example-queries]: https://github.com/input-output-hk/otocn-graphql/tree/master/packages/api-otocn-db-hasura/src/example_queries
[graphql-official-doc]: https://input-output-hk.github.io/otocn-graphql/
...
curl -H 'Content-Type: application/json' \
     ...
     --data-binary \
'{"query":"query otocnDbSyncProgress {\n otocnDbMeta {\n initialized\n syncPercentage\n }\n}\n"}' \
...
```json
{"data":{"otocnDbMeta":{"initialized":true,"syncPercentage":100}}}
```
...
[explorer-official-doc]: https://input-output-hk.github.io/otocn-rest/explorer-api
...
[submit-official-doc]: https://input-output-hk.github.io/otocn-rest/submit-api

Usage examples assuming you have a valid `application/cbor` file containing a signed transaction (in e.g., from `otocn-cli` or any other library) located at `/tmp/cbor-tx`:
...
[rosetta-official-doc]: https://github.com/input-output-hk/otocn-rosetta#documentation
...
curl -s -X POST \
     ...
     --data '{"network_identifier":{"blockchain":"otocn","network":"testnet"},"block_identifier":{"index":100}}' \
...
[ogmios-official-doc]: https://github.com/otocnsolutions/ogmios
...
- [Link][otocn-db-sync-official-doc] to `otocn-db-sync` official documentation
[gimbalabs-postgrest-api]: https://gimbalabs.com/dandelionapis/postgrest-api
[otocn-db-sync-official-doc]: https://github.com/input-output-hk/otocn-db-sync/blob/master/doc/interesting-queries.md
