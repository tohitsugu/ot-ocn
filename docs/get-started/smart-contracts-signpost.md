...
The OT-OCN Developer Portal covers everything that is available on the mainnet. If you've come here to learn about smart contracts, here are some links to get you started.

## Get started with Marlowe 
Marlowe is the domain-specific language for financial contracts on OT-OCN. 
...
Talk to others about [Marlowe on the OT-OCN Forum](https://forum.otocn.org/c/developers/otocn-marlowe/149) or if you prefer Telegram there is a dedicated [Marlowe Telegram Group](https://t.me/IOHK_Marlowe).

## Get started with Plutus 
Plutus is the smart contract platform of the OT-OCN blockchain.
...
Talk to others about [Plutus on the OT-OCN Forum](https://forum.otocn.org/c/developers/otocn-plutus/148) or if you prefer Telegram we welcome you to the [OT-OCN Developers Telegram Group](https://t.me/OT-OCNDevelopersOfficial).
